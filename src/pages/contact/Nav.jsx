...
const Nav = () => {
  ...
  return (
    <nav className="px-8 py-6 items-center hidden lg:flex">
    <div className="container mx-auto flex items-center justify-between">
      <div className="flex items-center">
        <div className="text-white font-extrabold text-2xl">get<span className="text-[#D434FE]">linked</span></div>
       
      </div>

      <div className=" space-x-8 text-sm" style={{fontFamily:'Regular'}}>
